...
::: notes
Monthly Hgb measurements and EPO doses
But the data is unbalanced.
:::
...
::: notes
Firt we model the linear relationship of each subject's hemoglobin with time
Then we modeled the between-subject variability by examining the effect of age on the intercepts and slopes
:::
...
We modeled individual Hb over time and R squared and F_test suggested that a quadratic relationship with time may explain the data better than linear relationship
:::
...
::: notes
Change of Hgb level from baseline to the last measured level varied dramatically.
Majority of patients tended to have minor change in Hgb levels. 
Increase in age leads to increase in AUC. 
Disadvantages: only use partial information so not insightful
:::
